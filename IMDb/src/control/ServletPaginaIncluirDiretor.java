 ...
 */
@WebServlet("/paginaIncluirDiretor")
public class ServletPaginaIncluirDiretor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletPaginaIncluirDiretor() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<H2>Novo Diretor</H2>");
		out.println("<FORM ACTION='incluirDiretor'>");
