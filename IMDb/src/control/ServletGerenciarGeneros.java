 ...
 */
@WebServlet("/gerenciarGeneros")
public class ServletGerenciarGeneros extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletGerenciarGeneros() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/respostaGerenciarGeneros.jsp");
